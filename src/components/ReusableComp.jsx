...
const ReusableComp = ({
  ...
  return (
    <div className="h-20 mt-4 grid place-items-center rounded-xl bg-[#282828] shadow-gray-700">
      <div className="px-4 flex items-center w-full h-8">
        ...
        <input
          ...
          checked={checked}
          onChange={() => onCheck(id)}
          className={`w-8 h-8 text-[${customColor}]  rounded-xl focus:ring-[${customColor}] ring-offset-gray-800  bg-[#3D3D3D] border-gray-600"`}
        />
      </div>
    </div>
  );
